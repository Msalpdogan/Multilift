...
THREE.PlayerControls = function ( camera, player, domElement ) {
	...
	this.center = new THREE.Vector3( player.position.x+2.5, player.position.y, player.position.z+2.5 );
	...
	this.update = function() { 
		...
		if ( this.autoRotate ) {
			...
			this.camera.position.x += this.autoRotateSpeed * ( ( this.player.position.x + 18 * Math.sin( this.player.rotation.y ) ) - this.camera.position.x );
			this.camera.position.z += this.autoRotateSpeed * ( ( this.player.position.z + 18 * Math.cos( this.player.rotation.y ) ) - this.camera.position.z );
